document.addEventListener('DOMContentLoaded', () => {
    ...
    const allSongs = [
        ...
        { id: 1, 
          ...
          timestamp: new Date('2025-07-29T00:00:00Z'),
        ...
        { id: 2, 
          ...
          timestamp: new Date('2025-07-31T04:35:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ0OTQ0NjFf/Lony%20Bway%20-%20NAPENDA.mp3' },
        { id: 3, 
          type: 'audio',
          title: 'Amanda', 
          artist: 'Zuchu',
          cover: 'https://od.lk/d/MjBfMzQ0OTQ1NTVf/Screenshots_2025-08-05-01-27-00.png',
          timestamp: new Date('2025-07-31T12:35:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ0OTQzMDBf/Zuchu%20-%20Amanda%20Clean%20Version.mp3' },
        { id: 4, 
          type: 'audio',
          title: 'Huyu Hapa', 
          artist: 'Kusah',
          ...
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ0OTQ2ODBf/Kusah%20-%20Huyu%20hapa.mp3' },
        { id: 5, 
          type: 'audio',
          title: 'Makosa', 
          artist: 'Obby Alpha',
          ...
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MDE5ODZf/Obby%20Alpha%20-%20MAKOSA.mp3' },
        { id: 6, 
          type: 'audio',
          title: 'Kimya', 
          artist: 'Lukamba',
          cover: 'https://od.lk/d/MjBfMzQ1MDIwMzFf/Lukamba-Kimya-820x545.jpg',
          timestamp: new Date('2025-08-05T13:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MDE5OTdf/Lukamba%20-%20Kimya.mp3' },
        { id: 7, 
          type: 'audio',
          title: 'We Umerogwa', 
          artist: 'B2K Feat. G Nako',
          cover: 'https://od.lk/d/MjBfMzQ1MDIwMzBf/B2K-Feat-G-nako-_-We-Umerogwa-820x545.jpg',
          timestamp: new Date('2025-08-05T23:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MDIwMjhf/B2K%20Feat%20G%20nako%20-%20We%20Umerogwa.mp3' },
        { id: 8, 
          type: 'audio',
          title: 'Mina Nawe', 
          artist: 'Ben Pol',
          cover: 'https://od.lk/d/MjBfMzQ1MDM1OTVf/Ben-Pol-Mina-Nawe-820x545.jpg',
          timestamp: new Date('2025-08-06T05:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MDM1OTFf/Ben%20Pol%20-%20Mina%20Nawe.mp3' },
        { id: 9, 
          type: 'audio',
          title: 'Tetema', 
          artist: 'Rayvanny Ft. Nora Fatehi & Shreya Ghosha',
        ...
        { id: 10, 
          type: 'audio',
          title: 'Hujanisahau', 
          artist: 'Walter Chilambo Feat. Japhet Zabron',
          cover: 'https://od.lk/s/MjBfMzQ1MzI2OTZf/Walter-Chilambo-Ft-Japhet-Zabron-%E2%80%93-Hajanisahau-600x400.jpg',
          timestamp: new Date('2025-08-10T00:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MzI2NTJf/Walter%20Chilambo%20Ft%20Japhet%20Zabron%20%E2%80%93%20Hajanisahau.mp3' },
        { id: 11, 
          type: 'audio',
          title: 'My Sugar', 
          artist: 'Mocco Genius',
          cover: 'https://od.lk/s/MjBfMzQ1MzI2OTRf/Mocco-Genius-My-Sugar-820x545.jpg',
          timestamp: new Date('2025-08-07T00:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MzI2NTVf/Mocco%20Genius%20-%20My%20Sugar.mp3' },
        { id: 12, 
          type: 'audio',
          title: 'My Gee', 
          artist: 'Chinno Kidd x Senny Motion x Enoplat',
          cover: 'https://od.lk/s/MjBfMzQ1MzI2OTVf/Chino-Kidd-x-Senny-Motion-x-Enoplat-%E2%80%93-My-Gee-820x545.jpg',
          timestamp: new Date('2025-08-07T00:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ1MzI2NTZf/Chino%20Kidd%20x%20Senny%20Motion%20x%20Enoplat%20%E2%80%93%20My%20Gee.mp3' },
        { id: 13, 
          type: 'audio',
          title: 'Ganda', 
          artist: 'D Voice x Mzee wa Bwax feat Whozu x G Nako',
          cover: 'https://od.lk/d/MjBfMzQ0OTQ3MTJf/Screenshots_2025-08-05-02-34-45.png',
          timestamp: new Date('2025-08-10T00:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://od.lk/d/MjBfMzQ0OTQ2ODRf/D%20Voice%20x%20Mzee%20wa%20Bwax%20feat%20Whozu%20%26%20G%20Nako%20-%20Ganda%20Remix.mp3' },
        { id: 14, 
          type: 'audio',
          title: 'Button', 
          artist: 'Chino Kidd X Dogo Elisha Feat. Mfanah Kah Gogo X Mdogo Sajent',
          cover: '',
          timestamp: new Date('2025-08-10T00:00:00Z'),
          tags: ['acoustic', 'chill', 'folk'],
          recommended: true, 
          audioUrl: 'https://drive.google.com/file/d/1lqoJKHH_VtjqepCeMQ_4hUn89228dTze/view?usp=drivesdk' },
        { id: 9, 
          type: 'audio',
          title: 'Tetema', 
          artist: 'Rayvanny Ft. Nora Fatehi & Shreya Ghosha',
